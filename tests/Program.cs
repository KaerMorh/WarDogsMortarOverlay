...
Check(Coordinates.Parse("x98.62, y109.57")==new Coord(98.62,109.57),"comma between labeled coordinates");
Check(Coordinates.Parse("Y109.57，X98.62")==new Coord(98.62,109.57),"localized separator and reversed axes");
Check(Coordinates.Parse("x98.62y109.57")==new Coord(98.62,109.57),"adjacent axis labels");
