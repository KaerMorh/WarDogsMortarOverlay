...
public partial class App:Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        })), verifyMultiplayer ? @"Local\WarDogsOverlay.MultiplayerVerify."+Environment.ProcessId : @"Local\WarDogsOverlay.Instance");
        ...
        Control=new Controller(e.Args.Contains("--demo")||e.Args.Contains("--verify")||verifyMultiplayer);
